...
const StatusFilter = ({ selectedStatus, setselectedStatus }) => {
    return (
        <Select onValueChange={(e) => setselectedStatus(e)} value={selectedStatus}>
            <SelectTrigger className="w-[170px] !border border-backgroundv3 focus:border focus:border-backgroundv3   text-textPrimary font-popins text-14 lg:text-14 bg-backgroundv2 rounded-lg py-3 px-3 h-full ">
